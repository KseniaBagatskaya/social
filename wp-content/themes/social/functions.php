...
function twentytwelve_scripts_styles() {
	...
	wp_enqueue_style( 'second-style', get_template_directory_uri() . '/css/second-style.css' );
	wp_enqueue_style( 'bootstrap-min', get_template_directory_uri() . '/css/bootstrap/bootstrap.min.css', array(), true );
	wp_enqueue_style( 'bootstrap', get_template_directory_uri() . '/css/bootstrap/bootstrap.css', array(), true );

	wp_enqueue_script('home', get_template_directory_uri() . '/js/home.js', true);
